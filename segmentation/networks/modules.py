...
def init_prototypes(n_classes, n_emb_dims, learnable=False, device=None):
    return torch.zeros((n_classes, n_emb_dims), dtype=torch.float32, requires_grad=learnable, device=device)
